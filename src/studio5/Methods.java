...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		StdDraw.filledCircle(0.5, 0.5, (3.0/4/0)*radius);

		// Red ring with 1.0/2.0 the radius
		// suggested rgb values: 146, 0, 0
		StdDraw.setPenColor(146, 0, 0);
		StdDraw.filledCircle(0.5, 0.5, (1.0/2.0)*radius);

		// Yellow ring with 1.0/4.0 the radius
		// suggested rgb values: 255, 255, 109
		StdDraw.setPenColor(255, 255, 109);
		StdDraw.filledCircle(0.5, 0.5, (1.0/4.0)*radius);
	}
	 ...
	 * @param c      the target character to be replaced
	 * @param replacement the replacement String
	 * 
	 * @return the String which results from substituting all of the target
	 *         characters in the source String with the replacement String
	 */
	public static String substituteAll(String source, char c, String replacement) {
		String result = "";
